...
export async function uploadAndSchedule({ channelId, file, title, description, tags, playlistId, publishAt }:{ channelId:string; file:NodeJS.ReadableStream|Buffer; title:string; description:string; tags:string[]; playlistId?:string; publishAt:Date; }){
